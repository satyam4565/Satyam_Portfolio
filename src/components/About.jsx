                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {/* Resume */}
                            <a href="https://drive.google.com/file/d/1NcTFnhgcJr7rkwli1360lJgBzVHOK_Is/view" target="_blank" rel="noopener noreferrer" className='flex items-center justify-between p-6 rounded-2xl bg-zinc-800 border border-white/5 hover:bg-zinc-700 transition-colors group'>
                                <div>
