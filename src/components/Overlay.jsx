...
const Overlay = () => {
    ...
    //Section 4
    const opacity4 = useTransform(scrollYProgress, [0.65, 0.70, 0.85, 0.90], [0, 1, 1, 0]);
    const y4 = useTransform(scrollYProgress, [0.65, 0.90], 50, -50);
    const blur4 = useTransform(scrollYProgress, [0.65, 0.70, 0.85, 0.90], [10, 0, 0, 10]);
